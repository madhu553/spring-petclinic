 ...
 * configuration creates the used cache for the application and enables
 * statistics that become accessible via JMX.
 */
...
class CacheConfiguration {
	 ...
	 * there is only a very limited set of configuration options. The really
	 * relevant configuration options (like the size limit) must be set via a
